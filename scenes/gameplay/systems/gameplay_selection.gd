...
const SELECTED_ID_BOX_SIZE := Vector2(120.0, 72.0)
const SELECTED_ID_FONT_SIZE := 34
const SELECTED_ID_TEXT_COLOR := Color(0.972549, 0.909804, 0.74902, 1)
...
# Creates one selected ID square with centered text.
